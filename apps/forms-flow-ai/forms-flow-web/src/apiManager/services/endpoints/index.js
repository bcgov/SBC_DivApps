...
const API = {
  ...
  GET_PROCESS_DEFINITION: `${BPM_BASE_URL_EXT}/process-definition/key/<process_key>`,
  PROCESSES_XML: `${BPM_BASE_URL_EXT}/process-definition/key/<process_key>/xml`,
  ...
  APPLICATION_EVENT_UPDATE: `${BPM_BASE_URL_EXT}/message`,
  GET_BPM_TASKS: `${BPM_BASE_URL_EXT}/task`,
  GET_BPM_TASK_DETAIL: `${BPM_BASE_URL_EXT}/task/<task_id>`,
  GET_BPM_TASK_VARIABLES: `${BPM_BASE_URL_EXT}/task/<task_id>/variables`,
  CLAIM_BPM_TASK: `${BPM_BASE_URL_EXT}/task/<task_id>/claim`,
  UNCLAIM_BPM_TASK: `${BPM_BASE_URL_EXT}/task/<task_id>/unclaim`,
  GET_BPM_PROCESS_LIST: `${BPM_BASE_URL_EXT}/process-definition`,
  GET_DMN_PROCESS_LIST: `${BPM_BASE_URL_EXT}/decision-definition`,
  GET_API_USER_LIST: `${WEB_BASE_URL}/user`,
  GET_BPM_FILTERS: `${BPM_BASE_URL_EXT}/filter`,
  GET_BPM_TASK_LIST_WITH_FILTER: `${BPM_BASE_URL_EXT}/filter/<filter_id>/list`,
  GET_BPM_TASK_LIST_COUNT_WITH_FILTER: `${BPM_BASE_URL_EXT}/filter/<filter_id>/count`,
  BPM_GROUP: `${BPM_BASE_URL_EXT}/task/<task_id>/identity-links`,
  DELETE_BPM_GROUP: `${BPM_BASE_URL_EXT}/task/<task_id>/identity-links/delete`,
  BPM_FORM_SUBMIT: `${BPM_BASE_URL_EXT}/task/<task_id>/submit-form`,
  GET_BPM_FORM_LIST: `${WEB_BASE_URL}/form`,
  UPDATE_ASSIGNEE_BPM_TASK: `${BPM_BASE_URL_EXT}/task/<task_id>/assignee`,
  ...
  DEPLOY_BPM: `${BPM_BASE_URL_EXT}/deployment/create`,
