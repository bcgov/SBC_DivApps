...
public class ProcessInstanceRestResourceImpl implements ProcessInstanceRestResource {
    ...
    public EntityModel<org.camunda.bpm.engine.rest.dto.runtime.ActivityInstanceDto> getActivityInstanceTree(String id) {
        ...
        org.camunda.bpm.engine.rest.dto.runtime.ActivityInstanceDto responseEntity = restService.getProcessInstance(id)
    ...
    public VariableValueDto getVariable(String variableName, boolean deserializeValue, String id) {
        return restService.getProcessInstance(id).getVariablesResource().getVariable(variableName);
    }
}
