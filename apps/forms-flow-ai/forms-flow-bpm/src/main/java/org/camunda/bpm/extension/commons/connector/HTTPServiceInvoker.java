 ...
 * This class prepares the payload and invokes the respective access handler
...
public class HTTPServiceInvoker {
    ...
    public ResponseEntity<String> executeWithParamsAndPayload(String url, HttpMethod method,
            Map<String, Object> requestParams, IRequest payload) {
